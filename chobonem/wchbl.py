...
wchbl_sankey("tunujuch'/pa_amaq_tnjch.json", ktbl, "wchbl_amaq/sankey")
wchbl_sankey("tunujuch'/pa_perulew_tnjch_pa_rtl_jlj.json", ktbl, "wchbl_prlw/sankey", pa_rtl_jlj="perulew")
wchbl_sankey("tunujuch'/pa_ruk'ojlem_tnjch_pa_rtl_jlj.json", ktbl, "wchbl_ruk'ojnem/sankey", pa_rtl_jlj='ixöq')
